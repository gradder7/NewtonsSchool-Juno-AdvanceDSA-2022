 ...
 * Problem Statement
 * An interviewer is asking you questions in form of queries. For your
 * assistance, he has provided you with an empty array. Queries are of 4 types:-
 * 
 * (1 X) Add given element X to end of the array
 * (2 X) Delete the first instance of given element X from the array(if element
 * is not present print -1)
 ...
 * 1 <= X <= 100000
 * Output
 * For queries 3 and 4, print the answer in a new line. If the array is empty
 * for query 2, 3 or 4, then print "-1" without the quotes.
 * Example
 * Sample Input:-
 * 6
 * 1 5
 ...
 * Query 6 -> Since there is no element in the array with value 1, so the output
 * is -1.
 */
